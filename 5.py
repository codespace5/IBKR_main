...
class TestApp(EWrapper, EClient):
    ...
    def start_trade(self, orderId):
        ...
        contracts = [
            self.create_contract("AAPL", "STK", "SMART", "USD", '20230519', 200, "C"),
            self.create_contract("AAPL", "STK", "SMART", "USD", '20230519', 210, "C"),
        ...
        for contract in contracts:
            ...
            # buy_order.eTradeOnly = False   <-- remove this line, it's not supported
