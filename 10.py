...
class TestApp(EWrapper, EClient):
    ...
    def start_trade(self, orderId):
        ...
        contracts = [
            self.create_contract("AAPL", "OPT", "SMART", "USD", '20230617', 200, "C"),
            self.create_contract("AAPL", "OPT", "SMART", "USD", '20230617', 210, "C"),
            # Add more contracts as needed...
        ]

        for contract in contracts:
            self.place_orders(orderId, contract)
            # Increase the order ID for the next contract
            orderId += 3

    def place_orders(self, orderId, contract):
